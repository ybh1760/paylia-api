...
export class JwtConfigService {
  ...
  get resetSecretKey(): string {
    return this.configService.get<string>('jwt.resetSecretKey');
  }
  get resetExpiresIn(): string {
    return this.configService.get<string>('jwt.resetExpiresIn');
  }
}
